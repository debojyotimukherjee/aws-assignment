...
spark-submit --master yarn --driver-memory 2g --num-executors 2 --executor-memory 1g --executor-cores 2 ${home_path}/spark/awsassignment_emr_spark_prepare_file.py -f ${home_path}/config/supplier.config -s "${data_source_name}" -e "aws-assignment"
